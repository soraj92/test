...
sub2021.init = function (oracledb, connection, binds, callback) {
    const sql = "BEGIN CODE113142TEST( :P_SCAN_BRNSHP_CD, :P_INV_NO, :P_DLY_KND_CD, :P_DLY_REA_CD, :P_SCAN_EMP, :P_SCAN_YMD, :P_SCAN_TME,  :P_CAR_CD, :P_SERIAL_NO, :P_RET_CODE, :P_RET_MESG); END;"

...
sub05.init = function (oracledb, connection, binds, callback) {
    const sql = "BEGIN SP_RF_HLC_BPCK_MAIN( :P_SCAN_BRNSHP_CD, :P_INV_NO, :P_BPCK_SCT, :P_SCAN_EMP, :P_SCAN_YMD, :P_SCAN_TME,  :P_CAR_CD, :P_SERIAL_NO, :P_RET_CODE, :P_RET_MESG); END;"
